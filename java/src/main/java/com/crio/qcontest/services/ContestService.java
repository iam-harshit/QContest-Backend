...
import com.crio.qcontest.exceptions.java.src.main.java.com.crio.qcontest.exceptions.ContestNotFoundException;
import com.crio.qcontest.exceptions.java.src.main.java.com.crio.qcontest.exceptions.ContestNotStartedException;
import com.crio.qcontest.exceptions.java.src.main.java.com.crio.qcontest.exceptions.InvalidContestException;
import com.crio.qcontest.exceptions.java.src.main.java.com.crio.qcontest.exceptions.UserNotFoundException;
...
public class ContestService{
    ...
    public Contestant createContestant(Long contestId, String userName) {
        ...
        return new Contestant(user, contest);
    ...
    public List<Contestant> contestHistory(Long contestId) {
        ...
        if(contest.getContestStatus().equals(ContestStatus.NOT_STARTED)){
            throw new ContestNotStartedException("Contest Not Yet Started!");
        }
